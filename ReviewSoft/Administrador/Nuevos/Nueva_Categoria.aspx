<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/Administrador.Master" AutoEventWireup="true" CodeBehind="Nueva_Categoria.aspx.cs" Inherits="ReviewSoft.Administrador.Nuevos.Nueva_Categoria" %>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Nueva Categoría <small>Agrega nuevas categorias de software al catálogo existente</small></h2>
